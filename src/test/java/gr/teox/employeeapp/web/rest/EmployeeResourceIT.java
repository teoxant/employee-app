...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "f^[J@+gYFd";
    private static final String UPDATED_EMAIL = "\\B@8";
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
